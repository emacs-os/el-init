...
before EXWM starts, supervisor.el has you covered.  ~M-x supervisor~
opens the interactive dashboard; ~supervisorctl~ provides the same
control from the terminal or scripts.
