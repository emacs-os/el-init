...
- *PID namespace harness* (~static-builds/tests/test-pid1-namespace.sh~) --
  optional runtime validation for ~--pid1~ behavior (boot hook timing,
  signal handling, child reaping, and non-~--pid1~ compatibility) via
