...
~svc.20250101-120000~) are automatically protected once they have been
rotated at least once (the rotated child confirms the parent as active).
For brand-new services that have not yet been rotated, use ~--protect-id~.
