...
| ~M-x supervisor-dashboard-toggle-enabled~ | Toggle enabled override (legacy) |
| ~M-x supervisor-dashboard-toggle-mask~ | Toggle mask (legacy) |
| ~M-x supervisor-dashboard-toggle-restart~ | Cycle restart policy (legacy) |
| ~M-x supervisor-dashboard-toggle-logging~ | Toggle logging (legacy) |
