...
<a href="supervisor_logo.png"><img align="right" width="300" src="supervisor_logo.png" alt="supervisor.el logo"></a>
...
The header line shows a bracket indicator when visibility filters are
active: =[targets]= when regular targets are shown, =[targets+init]=
when init-transition targets are also included.
