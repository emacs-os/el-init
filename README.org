...
| ~Group~ | Credentials and security |
...
| ~ConditionPathExists~ | Conditions and assertions |
| ~ConditionPathIsDirectory~ | Conditions and assertions |
| ~ConditionFileNotEmpty~ | Conditions and assertions |
| ~ConditionUser~ | Conditions and assertions |
| ~ConditionGroup~ | Conditions and assertions |
| ~ConditionHost~ | Conditions and assertions |
| ~ConditionEnvironment~ | Conditions and assertions |
| ~AssertPathExists~ | Conditions and assertions |
| ~AssertUser~ | Conditions and assertions |
